...
struct dissolve_dummy_robust_policy
{};
...
struct dissolve_ring
{
    ...
    static inline void apply_one(Ring const& input_ring,
                ...
                Visitor& visitor)
    {
        boost::ignore_unused(rescale_policy);

        using ring_point_type = typename geometry::point_type<Ring>::type;
        using ratio_type = typename detail::overlay::turn_info<ring_point_type>::segment_ratio_type;
        ...
        detail::self_get_turn_points::self_turns
            ...
            >(input_ring, strategy, turns, policy, 0, true);
        ...
        detail::overlay::enrich_discard_turns<overlay_dissolve>(
            turns, clusters, input_ring, input_ring, strategy);

        detail::overlay::enrich_turns<Reverse, Reverse, overlay_dissolve>(
            turns, input_ring, input_ring, strategy);
        ...
        detail::overlay::get_properties_ahead
            <
                Reverse,
                Reverse
            >(turns, clusters, input_ring, input_ring, strategy);

        // Some graph enrichment steps may update operation metadata.
        // Re-apply dissolve operation semantics before traversal.
        adapt_turns(turns);
        ...
        using area_result_type = typename area_strategy_type::template result_type<ring_point_type>::type;
        using properties = detail::overlay::ring_properties<ring_point_type, area_result_type>;
                                        ...
                                        Strategy const& strategy)
{
    ...
    detail::dissolve::dissolve_dummy_robust_policy robust_policy;
